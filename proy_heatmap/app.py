...
def render_heatmap():
    ...
    try:
        ...
        if not data:
            ...
            display_order = ["symbol", "asset", "price_heatmap", "daily_change_pct", "mcap"] + timestamp_cols
            ...
            column_config = {
                ...
                "price_heatmap": st.column_config.NumberColumn("Price Heatmap", format="$%.2f"),
